...
VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 1865764534, 1, current_date - interval '7 days',
        'Coffee Shop', 'Withdrawal', 30, 34500,
        current_date - interval '7 days');


INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary,
                                  transaction_type, transaction_amt, closing_balance, create_dt)
VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 1865764534, 1, current_date - interval '6 days',
        'Uber', 'Withdrawal', 100, 34400, current_date - interval '6 days');

INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary,
                                  transaction_type, transaction_amt, closing_balance, create_dt)
VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 1865764534, 1, current_date - interval '5 days',
        'Self Deposit', 'Deposit', 500, 34900, current_date - interval '5 days');

INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary,
                                  transaction_type, transaction_amt, closing_balance, create_dt)
VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 1865764534, 1, current_date - interval '4 days',
        'Ebay', 'Withdrawal', 600, 34300, current_date - interval '4 days');

INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary,
                                  transaction_type, transaction_amt, closing_balance, create_dt)
VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 1865764534, 1, current_date - interval '2 days',
        'OnlineTransfer', 'Deposit', 700, 35000, current_date - interval '2 days');

INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary,
                                  transaction_type, transaction_amt, closing_balance, create_dt)
VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 1865764534, 1, current_date - interval '1 days',
        'Amazon.com', 'Withdrawal', 100, 34900, current_date - interval '1 days');


CREATE TABLE loans
(
    loan_number        int          NOT NULL generated by default as identity,
    customer_id        int          NOT NULL,
